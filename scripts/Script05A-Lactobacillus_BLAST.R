...
#                                    TFM
###############################################################################
# Script 05A: Lactobacillus - exportación, BLASTn y procesamiento
###############################################################################

# Objetivo:
#   1. Seleccionar dinámicamente los ASVs clasificados como Lactobacillus.
...
#   - filtro taxonómico: Lactobacillus[Organism]
#   - word_size: 28
#   - evalue: 10
#   - HITLIST_SIZE: 500
#
...
#
# Entrada:
#   - cleaned/ps_taxFiltered.rds
#
# Salidas principales:
#   - Lactobacillus_ASV_mapping.csv
#   - Lactobacillus_ASVs.fasta
#   - BLAST_RID.txt
#   - BLAST_run_metadata.csv
#   - BLAST_database_metadata.csv
#   - BLAST_table_raw.csv
...
EVALUE <- 10
HITLIST_SIZE <- 500
ORGANISM_FILTER <- "Lactobacillus[Organism]"
...
if (n_selected == 0)
  stop(
    "No se encontraron ASVs de Lactobacillus.")
...
cat(
  "\nASVs de Lactobacillus exportados:",
  length(seqs),
  "\n")
...
cat(
  "\nBLAST Lactobacillus COMPLETADO\n")
...
write_csv(
  ...
  file.path(
    blast_dir,
    "BLAST_software_versions.csv"))

session_info_file <- file.path(
  blast_dir,
  "BLAST_sessionInfo.txt")
